...
#        self.stdout.write(options.__str__())
        ...
        START_DATE = pytz.timezone('Asia/Tokyo').localize(datetime.datetime.strptime('2020-01-01 00:00:00', '%Y-%m-%d %H:%M:%S').replace())
        END_DATE = pytz.timezone('Asia/Tokyo').localize(datetime.datetime.now())
